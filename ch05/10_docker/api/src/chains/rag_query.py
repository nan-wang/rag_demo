...
import dotenv
import tcvectordb
from chains.prompts import GENERATION_PROMPT
from chains.tcvectordb_hybrid_search import TencentVectorDBRetriever
...
dotenv.load_dotenv("/Users/nanwang/Codes/nan-wang/rag_demo/ch05/10_docker/.env")
