...
dotenv.load_dotenv(".siliconflow.v3.env")
...
llm = ChatOpenAI(model="Qwen/Qwen2.5-7B-Instruct").with_structured_output(Response)
...
output_path = "../03_eval/data_metrics/v20241219/ch0507_qwen25_7b_instruct/response.json"
