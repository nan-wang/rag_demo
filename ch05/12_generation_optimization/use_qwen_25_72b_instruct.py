...
dotenv.load_dotenv(".siliconflow.env")
...
llm = ChatOpenAI(model="Qwen/Qwen2.5-72B-Instruct").with_structured_output(Response)
...
output_path = "../03_eval/data_metrics/v20241219/ch0507_qwen25_72b_instruct/response.json"
